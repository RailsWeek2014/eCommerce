...
class PaymentMethodsControllerTest < ActionController::TestCase
  ...
  test "should create payment_method" do
    assert_difference('PaymentMethod.count') do
      post :create, payment_method: { payment_description: @payment_method.payment_description, payment_name: @payment_method.payment_name }
    end
  ...
  test "should update payment_method" do
    patch :update, id: @payment_method, payment_method: { payment_description: @payment_method.payment_description, payment_name: @payment_method.payment_name }
    assert_redirected_to payment_method_path(assigns(:payment_method))
  end
